...
function AdminProductNewPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.sku.trim() || !form.name.trim() || !form.price || !form.image) {
      setError("SKU, 상품명, 가격, 이미지는 필수입니다.");
      return;
    }
    ...
    <div className="admin-layout">
      ...
      <main className="admin-main">
        <header className="admin-header">
          <h1 className="admin-header-title">NEW PRODUCT</h1>
        ...
        <div className="apn-title-row">
          <h2 className="admin-section-title">NEW PRODUCT</h2>
          <p className="admin-section-desc">새 상품을 등록합니다</p>
        </div>
            ...
            <section className="apn-card">
              ...
              >
                {imagePreview ? (
                  ...
                  <div className="apn-upload-placeholder">
                    ...
                    <p className="apn-upload-hint">JPG, PNG · 최대 10MB · 최대 6장</p>
                  </div>
                )}
              </div>
              ...
              {imagePreview && (
                <div className="apn-thumb-row">
                  ...
                  <button type="button" className="apn-thumb-add" onClick={openWidget}>
                    +
                  </button>
                </div>
              )}
